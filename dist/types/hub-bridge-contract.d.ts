...
export interface HubBridge {
     ...
     */
    setPluginConfig(configs: HubBridgePluginConfigEntry[]): Promise<HubBridgePluginConfigResult>;
    /**
    ...
    uploadArtefact(input: HubBridgeUploadArtefactInput): Promise<HubBridgeUploadArtefactResult>;
